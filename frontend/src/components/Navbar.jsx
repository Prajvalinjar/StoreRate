      ...
      {mobileMenuOpen && (
        <div className="lg:hidden bg-[#123027] border-b border-[#0F2B23] px-4 pt-3 pb-6 space-y-4 text-xs font-medium text-[#D0E2DB] text-left">
          <div className="flex flex-col space-y-2 pt-2">
            <Link to="/" onClick={() => setMobileMenuOpen(false)} className="px-3 py-2 hover:bg-[#173D32] rounded-xl transition-colors font-semibold">
              Home
            </Link>
            <Link to="/stores" onClick={() => setMobileMenuOpen(false)} className="px-3 py-2 hover:bg-[#173D32] rounded-xl transition-colors font-semibold">
              Explore Stores
            </Link>
            <Link to="/categories" onClick={() => setMobileMenuOpen(false)} className="px-3 py-2 hover:bg-[#173D32] rounded-xl transition-colors font-semibold">
              Categories
            </Link>
            <Link to="/how-it-works" onClick={() => setMobileMenuOpen(false)} className="px-3 py-2 hover:bg-[#173D32] rounded-xl transition-colors font-semibold">
              How It Works
            </Link>
            <Link to="/about" onClick={() => setMobileMenuOpen(false)} className="px-3 py-2 hover:bg-[#173D32] rounded-xl transition-colors font-semibold">
              About Us
            </Link>
          </div>
